...
import (
	...
	"gvisor.dev/pkg/sentry/platform/kvm"
	"gvisor.dev/pkg/sentry/platform/ptrace"
	"gvisor.dev/pkg/sentry/sighandling"
	...
	"gvisor.dev/pkg/tcpip/transport/icmp"
	"gvisor.dev/pkg/tcpip/transport/tcp"
	"gvisor.dev/pkg/tcpip/transport/udp"
	"gvisor.dev/runsc/boot/filter"
	"gvisor.dev/runsc/specutils"

	// Include supported socket providers.
	"gvisor.dev/pkg/sentry/socket/epsocket"
	"gvisor.dev/pkg/sentry/socket/hostinet"
	_ "gvisor.dev/pkg/sentry/socket/netlink"
	_ "gvisor.dev/pkg/sentry/socket/netlink/route"
	_ "gvisor.dev/pkg/sentry/socket/unix"
)
